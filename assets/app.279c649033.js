...
return GL_PEER;}
var GL_SEARCH=null;async function ensureGlSearch(){if(GL_SEARCH)return GL_SEARCH;try{const res=await fetch('/moneyweb/api/global_search.json?t='+Date.now(),_NC);const j=await res.json();GL_SEARCH=(j&&j.items)||[];}catch(e){console.warn('global_search 로드 실패',e);GL_SEARCH=[];}
return GL_SEARCH;}
