...
async function glPopup(tk,fb){if(!GL_PEER)await ensureGlPeer();ensureGlNH();await ensureCoreSet();if(!Object.keys(GL_LIVE).length)await ensureGlLive();const d=GL_PEER[tk];if(!d){glPopupLiteFB(tk,fb);return;}
